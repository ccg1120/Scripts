...
public class Console : MonoBehaviour {
    ...
    public Vector4 Margin = new Vector4(20,20, 20, 20);
    ...
    void OnGUI()
    {
        ...
        var rect = new Rect(Margin.x, Margin.y, Screen.width - (Margin.x + Margin.z), Screen.height - (Margin.y + Margin.w));
        //var rect = new Rect(20, 20, Screen.width - (40), Screen.height - (Margin.y + Margin.w));
        windowRect = GUILayout.Window(123456, rect, DrawWindow, windowTitle);
    }
